# Generated by Django 4.2.9 on 2024-12-11 19:34
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('finance_app', '0014_dinifytransaction_transaction_notes'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aba_number', models.CharField(blank=True, max_length=255, null=True)),
                ('routing_number', models.CharField(blank=True, max_length=255, null=True)),
                ('yo_reference', models.CharField(blank=True, max_length=255, null=True)),
